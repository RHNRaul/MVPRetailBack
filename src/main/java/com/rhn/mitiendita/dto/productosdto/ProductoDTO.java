...
public class ProductoDTO {
    ...
    public ProductoDTO(Producto producto){
        ...
        this.codigopersonal = producto.getCodigopersonal();
        this.nombre = producto.getNombre();
        this.cantidad = producto.getCantidad();
        this.precio = producto.getPrecio();
        this.agregarIVA = producto.isAgregarIVA();
    }
    public ProductoDTO(String codigobarras, String codigopersonal, String nombre, int cantidad, String precio,
            boolean agregarIVA) {
